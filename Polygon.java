	...
	class Polygon extends Shape
	{
	     ...
	     *
	     */
	    public Polygon( int n, float poly_x[], float poly_y[], int shaderProgram )
	    {
	    ...
	    public Polygon( Vertices vertices, int shaderProgram )
	    {
	        shaderPgm = shaderProgram;
	        ...
	        nVerts = vertices.getDx().length;
	        coords = new float[ nVerts * 2 ];
	        
	        float poly_x[] = vertices.getDx();
	        float poly_y[] = vertices.getDy();
